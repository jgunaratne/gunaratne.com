...
export default function PodPalPrivacy() {
  return (
      ...
      <div className="max-w-2xl mx-auto px-6 py-16">
        <div className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm">
          <div className="flex items-center gap-4 mb-2">
            ...
            />
            <h1 className="text-3xl font-bold">PodPal — Privacy Policy</h1>
          </div>
          <p className="text-gray-500 mb-8 italic text-sm">Last Updated: June 24, 2026</p>

          <div className="space-y-6 leading-relaxed text-gray-700">
            <p>
              PodPal is an AI podcast player that transcribes, summarizes, and lets you chat
            ...
            <p>
              An account is optional — PodPal can be used as a guest without signing in.
              ...
              Signing in is required to use the built-in AI and to subscribe to PodPal Pro.
            </p>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>PodPal Pro subscribers (signed in):</strong> AI features are powered
            ...
            <p>
              ...
              podcasts you've used AI features on) and your PodPal Pro subscription status.
            ...
            <p>
              PodPal Pro is a $4.99/month auto-renewable subscription processed entirely by
            ...
            <p>
              You can delete your account at any time from within PodPal, or by{' '}
            ...
            <p>PodPal relies on the following third-party services:</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>
            ...
            <p>
              PodPal is not directed to children under 13, and we do not knowingly collect
